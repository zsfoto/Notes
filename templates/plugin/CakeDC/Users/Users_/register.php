...
*/ ?>
					...
					<div class="input-group mb-3">
						<?= $this->Form->control('email', ['type' => 'text', 'label' => false, 'placeholder' => __d('cake_d_c/users', 'Email'), 'class' => 'form-control', 'required' => true, 'templates'=>['inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}']]) ?>
						<div class="input-group-append">
							<div class="input-group-text">
								<span class="fas fa-envelope"></span>
							</div>
								...
								<?php
									if (Configure::read('Users.Tos.required')) {
										echo $this->Form->control('tos', [
											'type' => 'checkbox', 
											'label' => ' ' . __d('cake_d_c/users', 'Accept TOS conditions?'), 
											'required' => true
										]);
									}
