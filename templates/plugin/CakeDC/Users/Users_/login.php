		...
		<div class="card card-outline card-primary">
			<div class="card-header text-center">
				<a href="/login" class="h1">
					...
					<span style="font-weight: bold; float: left;"><?= __('Notes') ?></span>
				</a>
			</div>
			<div class="card-body">
				...
				<?= $this->Form->create() ?>
					...
					<div class="input-group mb-3">
						<?= $this->Form->control('username', ['label' => false, 'placeholder' => __d('cake_d_c/users', 'Email'), 'class' => 'form-control', 'required' => true, 'templates'=>['inputContainer' => '{{content}}', 'inputContainerError' => '{{content}}{{error}}'] ]) ?>
