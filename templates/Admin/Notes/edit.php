				...
				<?= $this->Form->create($note, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<?= $this->Form->textarea('body', ['type'=>'textarea', 'class'=>'summernote', 'label' => false, 'placeholder'=>__('Place some text here'), 'empty' => true, 'style'=>'width: 100%; height: 500px;', "required" => true ]) ?>
							</div>
						</div>
