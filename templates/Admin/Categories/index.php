...
<?php if(isset($config['index_show_counts']) && $config['index_show_counts']){ ?>
								<th class="note-count integer"><?= $this->Paginator->sort('note_count') ?></th>
<?php } ?>
...
<?php } ?>
								<td class="name string" name="name" value="<?= $category->name ?>"><?= h($category->name) ?></td><!-- bake-2 -->
<?php if(isset($config['index_show_counts']) && $config['index_show_counts']){ ?>
								<td class="note-count integer" name="note-count" value="<?= $this->Number->format($category->note_count) ?>"><?= $this->Number->format($category->note_count) ?></td><!-- bake-3 -->
<?php } ?>
<?php if(isset($config['index_show_visible']) && $config['index_show_visible']){ ?>
